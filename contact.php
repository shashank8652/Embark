                    ...
                    <form>
                        ...
                        <div class="form-group mb-4">
                            <select class="form-select" aria-label="Default select example">
                                ...
                                <option selected value="Are you an employer looking to hire candidates?">Are you an employer looking to hire candidates?</option>
                                <option value="Are you an employee looking for global jobs? ">Are you an employee looking for global jobs? wo</option>
                            </select>
                        </div>
                        <div class="form-group mb-4">
                        ...
                        <div class="cta-btn">
                          <button type="submit" class="text-center cta-bg">Submit <img src="images/contact-icon.png"></button>
                        </div>
                    </form>
                </div>
    ...
    <div class="row">
          <div class="col-md-4">
            <div class="bg-white pd border-radius20 box-shadow height150">
                ...
                <p class="fs16">Co-working &work, Ansal Plaza Mall, 1st Floor, Sector – 15A, Faridabad, Haryana 121007, India</p>
            </div>
          </div>
