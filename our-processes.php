                ...
                <div class="">
                    ...
                    <ul class="">
                        <li class="comfortaa fw500 line-height fs20 mb20">We start by understanding your specific needs,
                            including desired skillsets,
                            language proficiency levels, and timeline for hiring.</li>
                        <li class="margin-bottom-0 comfortaa fw500 line-height fs20">We then develop a customized
                            recruitment plan tailored to your unique requirements.</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="">
                    ...
                    <ul class="">
                        <li class="comfortaa fw500 line-height fs20 mb20">We offer comprehensive training programs in
                            German, Spanish, and French, delivered by qualified instructors.</li>
                        <li class="comfortaa fw500 line-height fs20 mb20">These programs are designed to develop strong
                            language skills tailored to your industry and lead to internationally recognized
                            certifications.</li>
                        <li class="margin-bottom-0 comfortaa fw500 line-height fs20">While candidates are undergoing
                            training, we keep you updated on their progress and performance.</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                ...
                <ul class="">
                    <li class="comfortaa fw500 line-height fs20 mb20">Our dedicated team handles the complexities of
                        work visa applications, ensuring compliance and timely processing.</li>
                    <li class="margin-bottom-0 comfortaa fw500 line-height fs20">We arrange one-way flight tickets for
                        your chosen candidates, facilitating their smooth transition to your company.</li>
                </ul>
            </div>
            ...
            <div class="col-md-6">
                ...
                <ul class="">
                    <li class="comfortaa fw500 line-height fs20 mb20">We offer ongoing support to ensure a smooth
                        integration for your new employees.</li>
                    <li class="comfortaa fw500 line-height fs20 mb20">This includes cultural orientation, assistance
                        with settling in, and continued language training if needed.</li>
                    <li class="margin-bottom-0 comfortaa fw500 line-height fs20">We facilitate open communication
                        between you and your new employees, fostering a positive working environment.</li>
                </ul>
